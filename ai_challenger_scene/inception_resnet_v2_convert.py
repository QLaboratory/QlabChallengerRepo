...
SCENE_MODEL_SAVE_PATH = "/home/yan/Desktop/QlabChallengerRepo/ai_challenger_scene/inception_resnet"
...
def InceptionResNetV2(img_rows, img_cols, color_type=1, num_classes=None):
    ...
    # Load weights
    model.load_weights('inception_resnet/inception_resnet_v2_weights_tf_dim_ordering_tf_kernels.h5')
        
    # Classification block
    x_new = GlobalAveragePooling2D(name='avg_pool')(x)
    x_new = Dense(num_classes, activation='softmax', name='predictions')(x_new)
...
if __name__ == '__main__':
    ...
    #save modeles
    CURRENT_TIME = "INCEPTION_RESNET_MODEL_WEIGHTS_"+datetime.now().strftime('%Y_%m_%d_%H_%M_%S')+".h5"
